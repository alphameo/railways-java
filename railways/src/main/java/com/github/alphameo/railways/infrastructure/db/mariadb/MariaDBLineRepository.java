...
public class MariaDBLineRepository implements LineRepository {
    ...
    public MariaDBLineRepository(Connection connection) {
    ...
    @Override
    public Optional<Line> findById(Id id) {
        try (PreparedStatement stmt = connection.prepareStatement(FIND_LINE_BY_ID)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    List<Id> stationIds = findStationIdsByLineId(id);
    ...
    private List<Id> findStationIdsByLineId(Id lineId) {
        List<Id> stationIds = new ArrayList<>();
    ...
    private void detachStations(Id lineId) {
    ...
    private void attachStations(Id lineId, List<Id> stationIds) {
