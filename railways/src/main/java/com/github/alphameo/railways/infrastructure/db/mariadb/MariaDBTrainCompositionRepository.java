...
public class MariaDBTrainCompositionRepository implements TrainCompositionRepository {
    ...
    public MariaDBTrainCompositionRepository(final Connection connection) {
        this.connection = connection;
    }

    @Override
    public void create(final TrainComposition entity) {
    ...
    public Optional<TrainComposition> findById(final Id id) {
        try (PreparedStatement stmt = connection.prepareStatement(FIND_TRAIN_COMPOSITION_BY_ID)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    final Id locomotiveId = Id.fromString(rs.getString("locomotive_id"));
                    final List<Id> carriageIds = findCarriageIdsByTrainCompositionId(id);
    ...
    public List<TrainComposition> findAll() {
        final List<TrainComposition> compositions = new ArrayList<>();
    ...
    @Override
    public void update(final TrainComposition entity) {
    ...
    private List<Id> findCarriageIdsByTrainCompositionId(final Id trainCompositionId) {
    ...
    private void detachCarriages(final Id trainCompositionId) {
    ...
    private void attachCarriages(final Id trainCompositionId, final List<Id> carriageIds) {
