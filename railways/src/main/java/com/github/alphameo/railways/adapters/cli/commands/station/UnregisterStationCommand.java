package com.github.alphameo.railways.adapters.cli.commands.station;
...
public class UnregisterStationCommand implements CliCommand {
    ...
    public UnregisterStationCommand(@NonNull final StationService service) {
    ...
    public void execute() {
        final var id = args[0];
        this.service.unregisterStation(id);
    }
}
